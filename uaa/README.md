...
```
$ docker image tag gateway anantgowadiya/gateway
$ docker push anantgowadiya/gateway
$ docker image tag quotes anantgowadiya/quotes
$ docker push anantgowadiya/quotes
$ docker image tag uaa anantgowadiya/uaa
$ docker push anantgowadiya/uaa
```
...
```
$ kubectl get svc gateway -n gotham
```
...
```
$ kubectl scale deployment <app-name> --replicas <replica-count> -n gotham
```
...
```
$ kubectl set image deployment/<app-name>-app <app-name>=<new-image>  -n gotham
```
...
```
$ kubectl get svc jhipster-console -n gotham
```
