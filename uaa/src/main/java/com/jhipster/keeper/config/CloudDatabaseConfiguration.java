package com.jhipster.keeper.config;
...
@Configuration
@EnableMongoRepositories("com.jhipster.keeper.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("com.jhipster.keeper.config.dbmigrations");
